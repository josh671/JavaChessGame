...
/////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        System.out.println("------------------------------------------------------------");
        System.out.println("testing pieceList");
        //todo: arraylist testing


        ChessBoard testArrayList = new ChessBoard();
        System.out.println(testArrayList.getListOFItems());

        System.out.println("------------------------------------------------------------");
        //testArrayList.killOrMovePiece(testArrayList.getChessBoard()[0][0], testArrayList.getChessBoard()[7][0]);
        //testArrayList.killOrMovePiece(testArrayList.getChessBoard()[7][0], testArrayList.getChessBoard()[7][2]);
        //testArrayList.killOrMovePiece(testArrayList.getChessBoard()[7][2], testArrayList.getChessBoard()[6][2]);
        //testArrayList.killOrMovePiece(testArrayList.getChessBoard()[0][5], testArrayList.getChessBoard()[5][0]);



        System.out.println("here " + testArrayList.getIsWkingChecked());
        ...
        for(int i = 0; i <= 7; i++){
            for(int f = 0; f <= 7; f++){
                System.out.println(testArrayList.getChessBoard()[i][f].getOccupyingPiece());
            }
        }
